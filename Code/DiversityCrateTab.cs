    ...
    class DiversityCrateTab
    {
        ...
        public static void createTab(string buttonID, string tabID, string name, string desc, int xPos)
        {
            ...
            if (OtherTabButton != null)
            {
                ...
                Localization.AddOrSet("agrichediversitycrate_mod_creator",  "Made By: Agriche");
                ...
                tipButton.text_description_2 = "agrichediversitycrate_mod_creator";
                ...
                var spriteForTab = Resources.Load<Sprite>("ui/Icons/tabIconDiversityCrate");
